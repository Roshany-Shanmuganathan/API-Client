 ...
 * Validation Schemas
 * 
 * This file contains all Zod validation schemas used for form validation.
 * Schemas are organized by feature/entity for better maintainability.
 */
...
/**
 * Member registration form validation schema
 */
  ...
  .object({
    ...
    location: z.object({
      ...
      district: z
        ...
        .refine(
          (val): val is typeof SRI_LANKAN_DISTRICTS[number] => 
            SRI_LANKAN_DISTRICTS.includes(val as typeof SRI_LANKAN_DISTRICTS[number]),
          {
