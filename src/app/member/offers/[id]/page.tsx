...
import { getOffer, getOfferReviews, clickOffer } from '@/services/offer.service';
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <div className="relative aspect-square w-full overflow-hidden rounded-lg border bg-muted">
            {offer.imageUrl ? (
              <Image src={offer.imageUrl} alt={offer.title} fill className="object-cover" priority />
            ) : (
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                {offer.partner?.location && (
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {offer.partner.location.street}, {offer.partner.location.city},{' '}
                ...
                {offer.analytics && (
                  <>
                    <div>
                      <span className="font-medium">Views:</span> {offer.analytics.views || 0}
                    </div>
                    <div>
                      <span className="font-medium">Clicks:</span> {offer.analytics.clicks || 0}
                    </div>
                  </>
                )}
              </div>
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">
                        {typeof review.member === 'object' && review.member.firstName
